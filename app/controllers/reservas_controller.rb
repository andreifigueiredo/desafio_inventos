class ReservasController < ApplicationController
  ...
  # GET /reservas/new
  def new
    @reserva = current_user.reservas.build
  end
  ...
  # POST /reservas.json
  def create
    @reserva = current_user.reservas.build(reserva_params)
  ...
  private
    ...
    def reserva_params
      params.require(:reserva).permit(:data_da_reserva, :preco_total, :confirmation)
    end
end
